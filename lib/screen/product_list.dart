...
class _ProductListState extends State<ProductList> {
  List<int> _quantities = List.generate(10, (index) => 0); // Quantity for each product
  String searchQuery = '';
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text("Fuji Apple", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: AppColors.primaryColor)),
          Text("10 min", style: TextStyle(fontSize: 14, color: AppColors.primaryColor)),
